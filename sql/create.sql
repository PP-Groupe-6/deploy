...
ALTER TABLE "transfer" ADD CONSTRAINT "Transfer_fk2" FOREIGN KEY ("transfer_state") REFERENCES "state"("state_id");

ALTER TABLE "invoice" ADD CONSTRAINT "Invoice_fk0" FOREIGN KEY ("invoice_state") REFERENCES "state"("state_id");
